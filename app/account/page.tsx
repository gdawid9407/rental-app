        ...
        <div className="p-8 space-y-10">
          ...
          <section className="bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-2xl p-6 transition-colors duration-200">
            <h2 className="text-lg font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
              <Plus size={20} className="text-blue-600 dark:text-blue-400" /> Dodaj Moduł Mieszkania
            </h2>
          ...
          {/* Lista Nieruchomości */}
          <section>
            <h2 className="text-lg font-bold text-gray-800 dark:text-white mb-4">Zdefiniowane Nieruchomości ({properties.length})</h2>
            ...
            {properties.length === 0 ? (
              ...
              <div className="grid gap-4">
                {properties.map(p => (
                  <div key={p.id} className="bg-white dark:bg-slate-800 border text-gray-900 dark:text-white border-gray-200 dark:border-slate-700 rounded-2xl p-5 shadow-sm transition hover:shadow-md dark:hover:shadow-blue-900/10">
                    ...
                    {editingId === p.id ? (
                      ...
                      <div>
                        {deletingId === p.id ? (
                           <div className="bg-orange-50 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-900 p-4 rounded-xl">
                            ...
                            <div className="space-y-3">
                              ...
                              >
                                <span className="block font-semibold text-red-600 dark:text-red-400 group-hover:text-red-700 dark:group-hover:text-red-300">Usuń całkowicie z rachunkami 🗑</span>
